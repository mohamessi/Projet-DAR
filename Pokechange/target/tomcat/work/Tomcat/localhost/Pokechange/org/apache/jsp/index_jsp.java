 ...
 * Generated at: 2017-10-06 13:12:26 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/footer.jsp", Long.valueOf(1507295130427L));
    _jspx_dependants.put("/menu.jsp", Long.valueOf(1507295546025L));
    _jspx_dependants.put("/scriptInclude.jsp", Long.valueOf(1507295253449L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title id=\"title\">POKECHANGE</title>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<img src=\"assets/img2/Pikachu.png\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"item\">\n");
      out.write("\t\t\t\t\t\t\t\t<img src=\"assets/img2/Nymphali.png\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"item\">\n");
      out.write("\t\t\t\t\t\t\t\t<img src=\"assets/img2/Pikachu.png\">\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t<h4 class=\"s-property-title\">Pikachu</h4>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<ul class=\"additional-details-list clearfix\">\n");
      out.write("\t\t\t\t\t\t\t<li><span class=\"col-xs-6 col-sm-4 col-md-4 add-d-title\">Possesseur</span>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"col-xs-6 col-sm-8 col-md-8 add-d-entry\">Karim</span>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li><span class=\"col-xs-6 col-sm-4 col-md-4 add-d-title\">Mis\n");
      out.write("\t\t\t\t\t\t\t\t\ten ligne</span> <span class=\"col-xs-6 col-sm-8 col-md-8 add-d-entry\">2017/09/30</span>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li><span class=\"col-xs-6 col-sm-4 col-md-4 add-d-title\">Exemplaires</span>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"col-xs-6 col-sm-8 col-md-8 add-d-entry\">2</span></li>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li><span class=\"col-xs-6 col-sm-4 col-md-4 add-d-title\">Extention</span>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"col-xs-6 col-sm-8 col-md-8 add-d-entry\">Dragon</span>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li><span class=\"col-xs-6 col-sm-4 col-md-4 add-d-title\">numero</span>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"col-xs-6 col-sm-8 col-md-8 add-d-entry\">5454564865</span>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li><span class=\"col-xs-6 col-sm-4 col-md-4 add-d-title\">Prix\n");
      out.write("\t\t\t\t\t\t\t\t\ten â¬</span> <span class=\"col-xs-6 col-sm-8 col-md-8 add-d-entry\">30</span>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\thref=\"/toto\">Accueil</a></li>\r\n");
      out.write("\t\t\t<li class=\"wow fadeInDown\" data-wow-delay=\"0.1s\"><a class=\"\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"order_by_date\" data-orderby=\"carte_date\"\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-order=\"ASC\"> Par Date <i class=\"fa fa-calendar\"></i>\n");
      out.write("\t\t\t\t\t\t\t\t</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t<li class=\"\"><a href=\"javascript:void(0);\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"order_by_price\" data-orderby=\"carte_prix\"\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-order=\"DESC\"> Par Prix <i\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label for=\"items_per_page\"><b>Cartes par page :</b></label>\n");
      ...
      out.write("\t\t\t\t\t\t\t\tclass=\"fa fa-th-list\"></i></a> <a class=\"layout-grid active\"\n");
      out.write("\t\t\t\t\t\t\t\thref=\"javascript:void(0);\"> <i class=\"fa fa-th\"></i>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"col-md-12 \">\n");
      out.write("\t\t\t\t\t\t<div id=\"list-type\" class=\"proerty-th\"></div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-12\">\n");
      ...
      out.write("\t\t\t\t\t\t<span> (C) <a href=\"#\">Pokechange</a> Tous droits réservés.\r\n");
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<li><a class=\"wow fadeInUp animated\" href=\"#\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-wow-delay=\"0.3s\">Données personnelles</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a class=\"wow fadeInUp animated\" href=\"#\"\r\n");
